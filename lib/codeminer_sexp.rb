...
require File.expand_path('../codeminer_sexp/formatters/begin', __FILE__)
...
require File.expand_path('../codeminer_sexp/formatters/ensure', __FILE__)
...
require File.expand_path('../codeminer_sexp/formatters/lambda', __FILE__)
